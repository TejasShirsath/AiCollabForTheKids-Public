 ...
 *
 * AFTER launch, the operational platform will donate 50% to charity.
 *
    ...
    const checkoutPayload = {
      ...
      order: {
        ...
        line_items: [{
          ...
          note: 'Founding Member: 20% off for life ($14.99/mo instead of $19.99). 50% of profits go to charity.'
        }],
        metadata: {
