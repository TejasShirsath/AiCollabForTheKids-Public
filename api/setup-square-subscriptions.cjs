 ...
 *
 * Run: node api/setup-square-subscriptions.cjs
 */
...
async function createSubscriptionPlans() {
  ...
  try {
    ...
    console.error('❌ Failed to create subscription plans:', error.message);
    ...
    try {
      ...
      console.error('❌ Failed to list existing plans:', catalogError.message);
      throw catalogError;
    }
  }
}
...
async function configureWebhooks(apiBaseUrl) {
  ...
  try {
    ...
    console.error('❌ Failed to configure webhooks:', error.message);
